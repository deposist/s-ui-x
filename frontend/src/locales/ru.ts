export default {
  ...
  ipCert: {
    title: "Сертификат для IP",
    subtitle: "Выпустить TLS-сертификат Let's Encrypt для IP-адреса (профиль shortlived) и автоматически продлевать его.",
    ip: "IP-адрес",
    email: "Email для ACME-аккаунта",
    port: "Порт HTTP-01 проверки",
    applyTarget: "Применить к",
    applyPanel: "HTTPS панели",
    autoRenew: "Автопродление",
    issue: "Выпустить сейчас",
    issuing: "Выпуск…",
    issued: "Выпущен",
    notIssued: "Не выпущен",
    expires: "Истекает",
    daysRemaining: "Осталось дней",
    lastRenew: "Последний выпуск",
    certPath: "Путь к сертификату",
    restartNotice: "Применение к панели перезапустит веб-интерфейс для загрузки нового сертификата.",
    invalidIp: "Введите корректный публичный IP-адрес.",
    portHint: "Порт 80 должен быть доступен из интернета во время проверки.",
  },
  presets: {
    title: "RU/ZH пресеты маршрутизации и DNS",
    subtitle: "Применяет curated rule-set, routing, DNS и cache-file изменения к локальной несохраненной конфигурации.",
    preset: "Пресет",
    proxyOutbound: "Proxy outbound",
    directOutbound: "Direct outbound",
    apply: "Применить к локальному config",
    preview: "Preview diff",
    sources: "Источники",
    selectOutbounds: "Выбери proxy и direct outbound tags перед применением.",
    sameOutboundWarning: "Proxy и direct outbound совпадают — разделение маршрутизации этого пресета не будет работать, пока не выбран отдельный proxy outbound.",
    zhMainlandDirect: "ZH: mainland direct",
    zhMainlandDirectDesc: "Маршрутизирует CN geosite/geoip напрямую, а non-CN домены через выбранный proxy outbound.",
    zhNonCnProxy: "ZH: non-CN proxy",
    zhNonCnProxyDesc: "Добавляет более узкий split: non-CN домены через proxy, CN домены напрямую.",
    ruBlockedProxy: "RU: blocked IP proxy",
    ruBlockedProxyDesc: "Маршрутизирует blocked ranges runetfreedom через proxy, private ranges напрямую.",
  },
  delivery: {
    title: "Доставка",
    rawLinks: "Raw links",
    ...
    noRawLinks: "Для этого клиента нет сохраненных raw links.",
  },
  login: {
    title: "Вход",
  ...
  setting: {
    ...
    subAdvanced: "Расширенный UX подписок",
