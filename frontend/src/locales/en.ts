export default {
  ...
  ipCert: {
    ...
    subtitle: "Issue a Let's Encrypt TLS certificate for an IP address (shortlived profile) and auto-renew it.",
    ip: "IP address",
    email: "ACME account email",
    port: "HTTP-01 challenge port",
    applyTarget: "Apply to",
    applyPanel: "Panel HTTPS",
    ...
    lastRenew: "Last issued",
    certPath: "Certificate path",
    restartNotice: "Applying to the panel restarts the web UI to load the new certificate.",
    invalidIp: "Enter a valid public IP address.",
    portHint: "Port 80 must be reachable from the internet during validation.",
  },
  presets: {
    title: "RU/ZH Routing and DNS Presets",
    subtitle: "Apply curated rule-set, routing, DNS, and cache-file changes to the local unsaved config.",
    preset: "Preset",
    ...
    sameOutboundWarning: "Proxy and direct outbound are the same — the split routing this preset provides will be inactive until you pick a distinct proxy outbound.",
