export default {
  ...
  form: {
    ...
    discard: "Discard",
    cannotSave: {
      tagRequired: "Enter a tag to save",
      nameRequired: "Enter a name to save",
      portRange: "Port must be between 1 and 65535",
      tlsRequired: "This protocol requires a TLS config",
      tlsIncompatible: "The selected TLS config is not compatible with this protocol",
      capabilityUnavailable: "This type is unavailable in the running core build",
    },
    sections: {
      basic: "Basic",
  ...
  guidance: {
    ...
    protocols: {
      vless: "Use a valid client UUID. Vision flow requires compatible TLS and transport settings; leave flow empty when those prerequisites are not intentional.",
      vmess: "Use a valid client UUID and Alter ID 0. Keep automatic security unless interoperability requires a specific cipher.",
      trojan: "Use a strong, unique client password. TLS is normally expected; configure fallback only when you operate the fallback service.",
      shadowsocks: "Select a method supported by every client and use a strong, unique password. Do not configure a plugin unless both ends require it.",
      socks: "Authentication is optional. Prefer SOCKS5 for current clients; expose the listener only to networks you trust.",
      http: "Authentication is optional. Enable TLS before exposing an HTTP proxy beyond a trusted network.",
    },
  },
  loading: "Loading...",
  ...
  login: {
    ...
    forcePasswordReset: "Your password must be changed before continuing.",
  },
  menu: {
    logout: "Logout",
    language: "Language",
